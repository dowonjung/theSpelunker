var boss = {
    create: function() {
        ...
        background = game.add.tileSprite(0, 0, 1600, 600, 'background1');
        ...
        // Player
        player = game.add.sprite(50, 500, 'playerSprite');
        ...
        // Boss
        boss = game.add.sprite(2000, 450, 'boss');
        ...
        bossWalk = boss.animations.add('bossWalk', [0, 1, 2, 3], 10, true);
        boss.play('bossWalk');
        ...
        // Music
        bossBG = game.add.audio('bossMusic', 1, true);
        bossBG.play();
    ...
    update: function(){        
        ...
        // Hitboxes
        game.physics.arcade.overlap(hitbox1, boss);
        game.physics.arcade.overlap(hitbox1, bombs);
        ...
        if(game.time.now > bombingTimer && boss.health > 0){
            this.createBomb();
        }
        game.physics.arcade.collide(bombs, ground, this.bombCollision, null, this);
        game.physics.arcade.overlap(player, bombs, this.playerDamaged, null, this);
    ...
    createBomb: function(){
        ...
        if(bomb){
            var random = game.rnd.integerInRange(800, 1500);
            bomb.reset(random, 10);
            bombingTimer = game.time.now + 4000;
        }
    },
