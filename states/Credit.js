var credit = {
  ...
  addCredit: function(task, author) {
    ...
    var authorText = game.add.text(400, 900, author, authorStyle);
    var taskText = game.add.text(400, 950, task, taskStyle);
  ...
  create: function () {
    ...
    musicPlayer = game.add.audio('ending');
    musicPlayer.play();
    this.addCredit('Is Cleared!', 'The Spelunker');
    this.addCredit('Developer', 'Dowon Jung');
    this.addCredit('Artist', 'Katy McQuaid');
    this.addCredit('Producer', 'Paul Toprac');
    this.addCredit('for playing', 'Thank you');
    this.addCredit('Amigos', 'The Dos');
